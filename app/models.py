...
class Toko(models.Model):
    thumbnail = models.ImageField(upload_to='D:/gotik-web-main/gotik-web-main/asetfoto/toko/thumbnail', blank=True, null=True)
...
class Produk(models.Model):
    nama_produk = models.CharField(max_length=1000)
    harga = models.CharField(max_length=1000)
    gambar_link = models.CharField(max_length=1000)
